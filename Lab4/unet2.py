# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 12:07:47 2019
...
def u_net2(Base,img_height, img_width, img_ch, batchNormalization, SDRate, spatial_dropout, final_neurons, final_afun):
    image_input = Input((img_height, img_width, img_ch))
    
    ## Contraction
    # Conv Block 1
    
    c1 = Conv2D(filters=Base,
                     kernel_size=(3,3), strides=(1,1), padding='same')(image_input)
    ...
    model = Model(inputs =image_input ,a18)
