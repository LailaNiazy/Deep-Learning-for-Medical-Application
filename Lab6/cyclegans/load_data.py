...
def load_data(nr_of_channels, batch_size=1, nr_A_train_imgs=None, nr_B_train_imgs=None,
              nr_A_test_imgs=None, nr_B_test_imgs=None, data_folder='/Lab1/Lab6/data_cyclegan/mrict/',
              generator=False, D_model=None, use_multiscale_discriminator=False, use_supervised_learning=False, REAL_LABEL=1.0):

    trainA_path = os.path.join(data_folder, 'trainA')
    trainB_path = os.path.join(data_folder, 'trainB')
    testA_path = os.path.join(data_folder, 'testA')
    testB_path = os.path.join(data_folder, 'testB')
